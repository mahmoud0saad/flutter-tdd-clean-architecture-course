  ...
  group('GetTriviaForYearNumber', () {
    ...
    test(
      ...
      () async {
        ...
        setUpMockInputConverterSuccess();
        // act
        bloc.add(GetTriviaForYearNumber(tNumberString));
        await untilCalled(mockInputConverter.stringToUnsignedInteger(any));
        // assert
        verify(mockInputConverter.stringToUnsignedInteger(tNumberString));
      },
    ...
    test(
      'should get data from the Year use case',
      () async {
        // arrange
        setUpMockInputConverterSuccess();
        when(mockGetYearNumberTrivia(any))
            .thenAnswer((_) async => Right(tNumberTrivia));
        // act
        bloc.add(GetTriviaForYearNumber(tNumberString));
        await untilCalled(mockGetYearNumberTrivia(any));
        // assert
        verify(mockGetYearNumberTrivia(Params(number: tNumberParsed)));
      },
    );
